...
class Laravel:
    ...
    icon = "{}/images/laravel.png".format(os.path.dirname(__file__))
    ...
    def handleQuery(self, search_item):
        ...
        if search_item:
            ...
            search = self.index.search(
                search_item,
                {"facetFilters": "version:10.x", "hitsPerPage": 5, "highlightPreTag": "...", "highlightPostTag": "..."}
            )
            ...
            if len(items) == 0:
                term = "laravel {}".format(search_item)
