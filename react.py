...
class React:
    client = SearchClient.create("1FCF9AYYAT", "e8451218980a351815563de007648b00")
    index = client.init_index("beta-react")
    icon = "{}/images/react.png".format(os.path.dirname(__file__))
    ...
    def handleQuery(self, search_item):
        ...
        if search_item:
            ...
            if len(items) == 0:
                term = "reactjs {}".format(search_item)
